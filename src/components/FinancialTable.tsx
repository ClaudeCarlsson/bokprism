        ...
        <table className="w-full min-w-[440px] text-xs sm:text-sm">
          <thead>
            <tr className="border-b border-zinc-200 dark:border-zinc-700">
              <th className="pb-2 pr-2 text-left font-medium text-zinc-500 sm:pr-4 dark:text-zinc-400">
                Post
              </th>
              {periods.map(h => (
                <th
                  key={h.period_end}
                  className="pb-2 pl-2 text-right font-medium text-zinc-500 sm:pl-4 dark:text-zinc-400"
                >
                ...
                >
                  ...
                  {periods.map(h => {
                    ...
                    return (
                      <td
                        key={h.period_end}
                        className={`py-2 pl-2 text-right tabular-nums text-zinc-900 sm:pl-4 dark:text-zinc-100 ${
